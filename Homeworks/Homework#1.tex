...
\begin{questions}
    ...
    \begin{solution}
        ...
        \begin{parts}
            ...
            \part 
            Using Wind Speed of 8: $\hat{y} = 2.9789 -6.935/(8) = 2.112025$\\
            ...
            \part $\beta_1 = [-0.2382301, -0.1986204]$, there is 99\%\ confidence that the true slope lies between the given values.
