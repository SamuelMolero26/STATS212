...
\begin{questions}
    ...
    \begin{solution}
        ...
        \begin{parts}
            ...
            Scatter plot $(1/x,y)$ suggests a linear relation.
            \part 
            \begin{verbatim}
            ...
            \end{verbatim}
            Given that the wind speed is 3.2, there is 95\%\ confidence that the true value lies within the interval $[0.74911,0.87451]$
